...
This data shows us a combination of all the trash collected between the 3 datasets. Also tells us how much total weight of trash was collected by Mr. Trash Wheel, Professor Trash Wheel and the Gwynnda Trash Wheel collectively. Additionally, it also shows all the different material that was collected. 

1. Number of observations in the resulting dataset: `r nrow(df_combined_trash)`

2. Number of key variables: `r ncol(df_combined_trash)`

3. Total weight collected by Professor Trash wheel: `r sum(df_prof_wheel$weight_tons)`
